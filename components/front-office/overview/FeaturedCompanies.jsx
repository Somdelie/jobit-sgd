    ...
    <div className="mt-8">
      ...
      <div className="flex gap-3 flex-wrap mt-4">
        {companies.map((company) => (
          <Fade key={company.id}>
            <div className="flex-1 basis-[12rem] bg-white dark:bg-dark-card transition dark:text-[#cbd5e1] w-[150px] h-[200px] p-3 border dark:border-dark-light rounded-[10px]">
